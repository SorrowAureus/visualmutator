...
namespace VisualMutator.Tests.Util {
  public static class TestProjects {
    ...
    public const string MiscUtilTests =
      @"C:\PLIKI\VisualMutator\testprojects\NUnit\MiscUtil\MiscUtil.UnitTests\bin\Debug\MiscUtil.UnitTests.dll";

    public static string LocalPath => Path.GetDirectoryName(new Uri(Assembly.GetExecutingAssembly().CodeBase).LocalPath);

    public static readonly string AutoMapper = 
      Path.GetFullPath(Path.Combine(LocalPath, @"..\..\..\..\packages\AutoMapper.6.2.0\lib\net45\AutoMapper.dll"));

    public static readonly string AutoMapperNet4 = 
      Path.GetFullPath(Path.Combine(LocalPath, @"..\..\..\..\packages\AutoMapper.6.2.0\lib\net45\AutoMapper.dll"));

    public static readonly string AutoMapperTests = 
      Path.GetFullPath(Path.Combine(LocalPath, @"..\..\..\..\packages\AutoMapper.6.2.0\lib\net45\AutoMapper.dll"));

    public static readonly string NUnitConsoleDirPath =
      Path.GetFullPath(Path.Combine(LocalPath, @"..\..\..\..\packages\NUnit.ConsoleRunner.3.7.0\tools"));
