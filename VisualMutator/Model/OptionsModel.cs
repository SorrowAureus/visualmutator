namespace VisualMutator.Model {
  ...
  public class OptionsModel : ModelElement {
    ...
    {
      get { return _mutantsCacheEnabled; }
      set { SetAndRise(ref _mutantsCacheEnabled, value, () => MutantsCacheEnabled); }
    }
    ...
    {
      get { return _useCodeCoverage; }
      set { SetAndRise(ref _useCodeCoverage, value, () => UseCodeCoverage); }
    }
    ...
    {
      get { return _whiteCacheThreadsCount; }
      set { SetAndRise(ref _whiteCacheThreadsCount, value, () => WhiteCacheThreadsCount); }
    }
    ...
    {
      get { return _processingThreadsCount; }
      set { SetAndRise(ref _processingThreadsCount, value, () => ProcessingThreadsCount); }
    }
    ...
    public int MaxNumerOfMutantPerOperator
    {
      ...
      set { SetAndRise(ref _maxNumerOfMutantPerOperator, value, () => MaxNumerOfMutantPerOperator); }
    }
    ...
    {
      get { return _timeFactorForMutations; }
      set { SetAndRise(ref _timeFactorForMutations, value, () => TimeFactorForMutations); }
    }
    ...
    {
      get { return _mutationOrder; }
      set { SetAndRise(ref _mutationOrder, value, () => MutationOrder); }
    }
    ...
    {
      get { return _mutationOrder2; }
      set { SetAndRise(ref _mutationOrder2, value, () => MutationOrder2); }
    }
    ...
    public string OtherParams
    {
      ...
      set { SetAndRise(ref _otherParams, value, () => OtherParams); }
    }
  ...
  public class OtherParams {
    ...
    public override string ToString() {
      return string.Format("LogLevel: {0}, DebugFiles: {1}, NUnitNetVersion: {2}, LegacyCreation: {3}", LogLevel,
        DebugFiles, NUnitNetVersion, LegacyCreation);
    }
  }
}