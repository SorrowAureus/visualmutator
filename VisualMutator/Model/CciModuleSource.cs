namespace VisualMutator.Model {
  ...
  public interface ICciModuleSource : IModuleSource {
    ...
    SourceEmitter GetSourceEmitter(CodeLanguage language, IModule assembly,
      SourceEmitterOutputString sourceEmitterOutput);
  }
  ...
  public class CciModuleSource : IDisposable, ICciModuleSource {
    ...
    public List<IModuleInfo> Modules => _moduleInfoList.Cast<IModuleInfo>().ToList();

    public List<ModuleInfo> ModulesInfo => _moduleInfoList;
    ...
    public MetadataReaderHost Host => _host;

    public ModuleInfo Module => (ModuleInfo) Modules.Single();
